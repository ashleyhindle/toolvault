...
Component.options.__file = "resources/js/components/ToolBox.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-81ad0610", Component.options)
  } else {
    hotAPI.reload("data-v-81ad0610", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        showTool: function showTool() {
            return this.filterBy.length < 2 || this.name.toLowerCase().indexOf(this.filterBy.toLowerCase()) != -1 || this.description.toLowerCase().indexOf(this.filterBy.toLowerCase()) != -1;
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-81ad0610", module.exports)
  }
}
